...
/**
 * @name getTransferTopic
 * @description Method use to get the topic label that will trigger if the transfer action is given
 * @param {string} functionName
 * @returns {string}
 */
exports.getTransferTopic = functionName => {
  return getEvents()[functionName].secondary;
};